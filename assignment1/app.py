...
app = Flask(__name__)
with open('C:/Users/Salma/Desktop/S3_master/cloud_native_ai_kelloubi/assignment1/svc.pkl', 'rb') as model_file:
...
def predict():
    ...
    dic = {1: 'Malignant', 0: 'Benign'}
    output = dic[prediction[0]]
